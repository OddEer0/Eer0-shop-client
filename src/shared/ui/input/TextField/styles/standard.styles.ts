...
export const StandardTextField = styled(BaseTextFieldWrapper)`
	&.primary {
		& > .label {
	...
	&.success {
		...
		& > .wrapper > .input {
			...
			color: inherit;
			border-radius: 0;
			border-bottom: 2px solid ${({ theme }) => theme.ui.color.success_50};
	...
	&.danger {
		...
		& > .wrapper > .input {
			...
			color: inherit;
			border-radius: 0;
			border-bottom: 2px solid ${({ theme }) => theme.ui.color.danger_50};
	...
	&.warning {
		...
		& > .wrapper > .input {
			...
			color: inherit;
			border-radius: 0;
			border-bottom: 2px solid ${({ theme }) => theme.ui.color.warning_50};
